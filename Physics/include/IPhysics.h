...
public:
	 ...
	 * @param p_Position sets the position for the boundingvolume(sphere). Body get same position
	 ...
	 * @param p_Mass is defineing the mass for the body
	 * @param p_IsImmovable tells if the body are movable
	 * @param p_Bot sets the bottom corner for box
	 * @param p_Top sets the top corner for box
	 * @param p_IsEdge flag if it's a Edge or not
	 * @return a BodyHandle so it can be mapped outside of Physics
	 */
	...
	/**
	 * Edit the velocity of the target body.
	 *
	 * @param p_Velocity is a vector3 with all the position coordinates
	 * @param p_Body are what body to work with
	 */
