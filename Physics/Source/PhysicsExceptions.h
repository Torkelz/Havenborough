...
public:
         ...
         */
        PhysicsException(const std::string& p_What, int p_Line, const std::string& p_File)
 ...
 */
class CollisionException : public PhysicsException
{
public:
        /**
         * constructor.
         ...
         * @param p_File The file of the exception (use __FILE__)
         */
        CollisionException(const std::string& p_What, int p_Line, const std::string& p_File)
