...
private:
	...
	static void checkCollisionDepth(float p_Min0, float p_Max0, float p_Min1, float p_Max1, float &p_Overlap, DirectX::XMVECTOR p_L, DirectX::XMVECTOR &p_Least);
	...
	static float checkMinMax(float min, float max, float p_R);
};
