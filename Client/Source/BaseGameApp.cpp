...
void BaseGameApp::init()
{
	...
	m_ResourceManager->registerFunction( "particleSystem", std::bind(&IGraphics::crateParticleSystem, m_Graphics, _1, _2), std::bind(&IGraphics::releaseParticleSystem, m_Graphics, _1));
