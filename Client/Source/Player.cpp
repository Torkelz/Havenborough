...
void Player::move()
{
	...
	Vector4 direction = m_Physics->calculateDirectionVector(getBody(), Vector3(m_DirectionX, 0.f, m_DirectionZ));

	XMFLOAT3 maxVelocity(direction.x * m_MaxSpeed, 0.f, direction.z * m_MaxSpeed);	// cm/s
