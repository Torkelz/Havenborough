...
BOOST_AUTO_TEST_SUITE(TriangleHullTest)
	...
	//	DirectX::XMFLOAT4 result = Collision::findClosestPointOnTriangle(DirectX::XMFLOAT4(0.f, 0.f, 0.f, 1.f), 0);
	...
	//	result = Collision::findClosestPointOnTriangle(DirectX::XMFLOAT4(0.f, 0.f, 0.f, 1.f), 1);
