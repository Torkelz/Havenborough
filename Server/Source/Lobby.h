...
public:
	 ...
	 * @param p_LevelPath the path to the level file
	 ...
	 */
	void addAvailableLevel(const std::string& p_LevelName, const std::string& p_LevelPath, unsigned int p_MaxPlayers, float p_WaitTime);
	/**
