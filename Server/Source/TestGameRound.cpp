...
void TestGameRound::setup()
{
	...
	m_Actors.push_back(m_ActorFactory->createParticles(Vector3(4850.0f, 0.0f, -2528.0f), "fire"));
	m_Actors.push_back(m_ActorFactory->createParticles(Vector3(-1000.0f, 0.0f, -1000.0f), "fire"));
	m_Actors.push_back(m_ActorFactory->createParticles(Vector3(-1000.0f, 0.0f, 1000.0f), "fire"));
	m_Actors.push_back(m_ActorFactory->createParticles(Vector3(1000.0f, 0.0f, 1000.0f), "fire"));
	m_Actors.push_back(m_ActorFactory->createParticles(Vector3(1000.0f, 0.0f, -1000.0f), "fire"));
}
