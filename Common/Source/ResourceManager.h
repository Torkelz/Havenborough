...
public:
	...
	/**
	 * Unregisters a registered type with associated create and release functions.
	 *
	 * Any resources of the given type is first released, even if they are in use.
	 *
	 * @param p_Type the type of resource to remove from the resource handler
	 */
	void unregisterResourceType(const std::string& p_Type);

	/**
	 * Load information from a resource file, 
	 * this implementation expects an .xml file generated by Binary Converter® by Philip
	 * @param p_FilePath is a complete path to the file with data.
	 */
	...
	/**
	 * Releases all resources not currently in use.
	 */
	void releaseUnusedResources();

	/**
	 * Sets the resource manager to release resources as soon as they become unused.
	 *
	 * If set to release, all currently unused resources will be released.
	 *
	 * @param p_Release true if resources should be released immediately
	 *			when they become unused, or false if they should be kept until
	 *			they are otherwise released.
	 */
