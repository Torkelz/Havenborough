...
public:
	...
	// ************ Test methods ************
	std::string getPlayerActorDescription(Vector3 p_Position, std::string p_Username, std::string p_CharacterName) const;
	...
	Actor::ptr createPlayerActor(Vector3 p_Position, std::string p_Username, std::string p_CharacterName);
