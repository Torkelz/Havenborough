...
public:
	...
	void playAnimation(InstanceId p_Instance, const char* p_ClipName, bool p_Override) override;
	void queueAnimation(InstanceId p_Instance, const char* p_ClipName) override;
	void changeAnimationWeight(InstanceId p_Instance, int p_Track, float p_Weight) override;
